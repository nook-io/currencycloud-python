...
class Conversions(Http):
    ...
    async def retrieve(self, resource_id: str, **kwargs: Any) -> Conversion:
        """Returns a json structure containing the details of the requested conversion."""
        return Conversion(**await self.get("/v2/conversions/" + resource_id, query=kwargs))
    ...
    async def cancel(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        return Conversion(**await self.post("/v2/conversions/" + resource_id + "/cancel", kwargs))
    ...
    async def date_change(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        return Conversion(**await self.post("/v2/conversions/" + resource_id + "/date_change", kwargs))
    ...
    async def split(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        return Conversion(**await self.post("/v2/conversions/" + resource_id + "/split", kwargs))

    async def split_preview(self, resource_id: str, **kwargs: Any) -> Conversion:
        """Returns a json structure containing split results as parent and child conversions."""
        return Conversion(**await self.get("/v2/conversions/" + resource_id + "/split_preview", kwargs))
    ...
    async def split_history(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        return Conversion(**await self.get("/v2/conversions/" + resource_id + "/split_history", kwargs))
    ...
    async def date_change_quote(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        """
        return Conversion(**await self.get("/v2/conversions/" + resource_id + "/date_change_quote", kwargs))
    ...
    async def cancellation_quote(self, resource_id: str, **kwargs: Any) -> Conversion:
        ...
        """
        return Conversion(**await self.get("/v2/conversions/" + resource_id + "/cancellation_quote", kwargs))

    async def profit_and_loss(self, **kwargs: Any) -> PaginatedCollection[ProfitAndLoss]:
        """
        ...
        data = [ProfitAndLoss(**fields) for fields in response["conversion_profit_and_losses"]]
        return PaginatedCollection(data, response["pagination"])
