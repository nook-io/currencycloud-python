...
class TestActions:
    ...
    async def test_actions_can_update(self) -> None:
        with my_vcr.use_cassette("actions/can_update.json"):
            beneficiary = await self.client.beneficiaries.update(
                TestActions.beneficiary_id, bank_account_holder_name="Test Name 2"
            )
    ...
    async def test_actions_can_current(self) -> None:
        with my_vcr.use_cassette("actions/can_current.json"):
    ...
    async def test_actions_can_validate_beneficiaries(self) -> None:
        with my_vcr.use_cassette("actions/can_validate_beneficiaries.json"):
            params = {
                "bank_country": "GB",
                "currency": "GBP",
    ...
    async def test_actions_can_verify_beneficiaries(self) -> None:
        with my_vcr.use_cassette("actions/can_verify_beneficiaries.json"):
            params = {
                "bank_country": "GB",
    ...
    async def test_actions_can_use_currency_to_retrieve_balance(self) -> None:
        with my_vcr.use_cassette("actions/can_use_currency_to_retrieve_balance.json"):
